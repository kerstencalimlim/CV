    ...
    return Scaffold(
      ...
      body: Container(
        color: Color.fromARGB(
            255, 216, 215, 215), // Set the background color to black
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            _buildInfoText("Mangin Tebeng Elementary School"),
  ...
  Widget _buildInfoText(String text) {
    return Padding(
      ...
      child: Text(
        text,
        style: TextStyle(
          color: Color.fromARGB(159, 5, 5, 5), // Set the text color to yellow
